...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/sst/zeus/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for sst/zeus...\n")
...
console.log("Fetching npm all-time downloads for zeus-ai...\n")
const npmDownloads = await fetchNpmDownloads("zeus-ai")

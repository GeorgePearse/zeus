...
// interacting with the zeus API. You should not instantiate this client
...
// DefaultClientOptions read from the environment (ZEUS_BASE_URL). This should
// be used to initialize new clients.
func DefaultClientOptions() []option.RequestOption {
	defaults := []option.RequestOption{option.WithEnvironmentProduction()}
	if o, ok := os.LookupEnv("ZEUS_BASE_URL"); ok {
...
// environment (ZEUS_BASE_URL). The option passed in as arguments are applied
